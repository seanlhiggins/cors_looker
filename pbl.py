...
def generate():
  user = User(
    ...
    models=[" _shiggins"],
    external_group_id="cors_embed_test"
  )

  looker = Looker('profservices.dev.looker.com', embed_secret)

  fifteen_minutes = 15 * 60

  url = URL(looker, user, fifteen_minutes, "/embed/dashboards-next/447?embed_domain=http://127.0.0.1:5000", force_logout_login=True)
